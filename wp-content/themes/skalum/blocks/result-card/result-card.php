...
$wide_desc = ($layout === 'results') ? get_field('card_with_description') : '';
...
<section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($class); ?>">
  <div class="container">
    <div class="cards-block__inner fade-in">
      ...
      <?php else : ?>
        <!-- RESULTS: stats cards + wide wysiwyg block -->
        <?php if (have_rows('cards') || !empty($wide_desc)) : ?>
            ...
            <?php if (have_rows('cards')) : ?>
              <div class="cards-block__stats">
                <?php while (have_rows('cards')) : the_row(); ?>
                  ...
                  $card_title = (string) get_sub_field('title');
                  $card_desc  = get_sub_field('description');
                  skalum_render_cards_block_card($icon, $card_title, $card_desc, 'cards-block__card--stat');
                  ?>
                <?php endwhile; ?>
              </div>
            <?php endif; ?>

            <?php if (!empty($wide_desc)) : ?>
              <article class="cards-block__card cards-block__card--wide">
                <div class="cards-block__card-body">
                  <?php echo wp_kses_post($wide_desc); ?>
                </div>
              </article>
            <?php endif; ?>
